...
template <typename S>
typename MutantStack<S>::MutantIterator			MutantStack<S>::begin( void )	{return (this->c.begin());}
template <typename S>
typename MutantStack<S>::MutantIterator			MutantStack<S>::end( void )		{return (this->c.end());}
template <typename S>
